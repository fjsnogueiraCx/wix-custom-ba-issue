    ...
    public class InstallationViewModel : PropertyNotifyBase
    {
        ...
        public ICommand LaunchHomePageCommand
        {
            get
            {
                ...
                {
                    this.launchHomePageCommand = new RelayCommand(param => WixBA.LaunchUrl("http://www.google.com"), param => true);
                }
        ...
        public ICommand LaunchNewsCommand
        {
            get
            {
                ...
                {
                    this.launchNewsCommand = new RelayCommand(param => WixBA.LaunchUrl("http://www.google.com"), param => true);
                }
